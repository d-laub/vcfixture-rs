...
///         BulkError::TooManyBlocks { .. } => 9,
///         BulkError::BadSize(_) => 10,
///         BulkError::BadRecordsFor(_) => 11,
///         BulkError::CompressionLevel(_) => 12,
///         BulkError::ProfileLoad { .. } => 13,
///         BulkError::WorkerPool(_) => 14,
///         BulkError::TargetNotReached { .. } => 15,
///         BulkError::Json(_) => 16,
///         BulkError::Io(_) => 17,
///     }
/// }
